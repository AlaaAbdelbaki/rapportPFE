...
\begin{center}
    \begin{figure}[H]
        \centering
        \includegraphics[height = 0.5\textheight]{ui_screenshots/app_screenshots/login_page_google.png}
        \vspace{1cm}
...
\begin{multicols}{2}
    \begin{figure}[H]
        \centering
        \includegraphics[height = 0.5\textheight]{ui_screenshots/app_screenshots/transfer_form.png}
        \captionsetup{justification=centering}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[height = 0.5\textheight]{ui_screenshots/app_screenshots/current_location.png}
        \captionsetup{justification=centering}
...
\begin{multicols}{2}
    \begin{figure}[H]
        \centering
        \includegraphics[height = 0.5\textheight]{ui_screenshots/app_screenshots/suggestions.png}
        \captionsetup{justification=centering}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[height = 0.5\textheight]{ui_screenshots/app_screenshots/directions.png}
        \captionsetup{justification=centering}
...
\begin{multicols}{2}
    \begin{figure}[H]
        \centering
        \includegraphics[height = 0.5\textheight]{ui_screenshots/app_screenshots/available_cars.png}
        \captionsetup{justification=centering}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[height = 0.5\textheight]{ui_screenshots/app_screenshots/available_cars_empty.png}
        \captionsetup{justification=centering}
